...
function handleDestinyChoice() {
    ...
    setTimeout(() => {
        ...
        selected.innerHTML = '🎁';
        siblings.forEach(box => box.style.pointerEvents = 'auto');
        navigateToScreen('level6Screen'); // Skips old Level 5 riddle straight to key input screen
    }, 2000);
}

// --- LEVEL 5 (PASSWORD OVERRIDE) ENGINE ---
